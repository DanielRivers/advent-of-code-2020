...
strings.forEach(string => {
  ...
  let validation = test[0].split(' ')
  let [first, second] = validation[0].split('-')
  let firstMatch = test[1][+first] === validation[1];
  let secondMatch = test[1][+second] === validation[1];

  if (firstMatch && secondMatch) return;
  if (firstMatch || secondMatch) match++
})
